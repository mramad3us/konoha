...
const SPAWN_CONFIG: Record<SpawnType, {
  ...
  bush_small:  { spriteId: 'obj_bush_small',  offsetY: -16, blocksMove: false, blocksSight: false, displayName: 'bush', article: 'a', objectCategory: 'terrain', description: 'A low, unremarkable shrub. Good for concealment if you crouch.' },
  bush_berry:  { spriteId: 'obj_bush_berry',  offsetY: -16, blocksMove: false, blocksSight: false, displayName: 'berry bush', article: 'a', objectCategory: 'terrain', description: 'Dark berries grow among the leaves. Some look edible, others less so.' },
  bush_tall:   { spriteId: 'obj_bush_tall',   offsetY: -20, blocksMove: true,  blocksSight: false, displayName: 'tall bush', article: 'a', objectCategory: 'terrain', description: 'A dense thicket, tall enough to block your path. Thorny branches discourage shortcuts.' },
  bush_flower: { spriteId: 'obj_bush_flower', offsetY: -16, blocksMove: false, blocksSight: false, displayName: 'flowering bush', article: 'a', objectCategory: 'terrain', description: 'Bright yellow flowers dot this bush, attracting small insects in the warm air.' },
