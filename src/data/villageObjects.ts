...
function bed(world: World, x: number, y: number): void {
  spawn(world, { x, y, spriteId: 'obj_sleeping_bag', layer: 'object', offsetY: -12,
...
export function spawnVillageObjects(world: World, devMode: boolean): void {
  ...
  spawn(world, { x: 65, y: 74, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 68, y: 74, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 62, y: 77, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 70, y: 77, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 66, y: 84, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 65, y: 16, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  // --- Library (78-85, 12-17) ---
  spawn(world, { x: 80, y: 14, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 83, y: 14, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 28, y: 88, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 64, y: 93, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 22, y: 95, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 84, y: 113, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 8, y: 105, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 10, y: 120, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
  ...
  spawn(world, { x: 110, y: 79, spriteId: 'obj_rock_small', layer: 'object', offsetY: -12,
